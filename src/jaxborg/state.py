...
class CC4State:
    ...
    fsm_host_entered: chex.Array  # (NUM_RED_AGENTS, GLOBAL_MAX_HOSTS) bool — host entered FSM
    ...
    host_orphaned_decoy_max_pid: chex.Array  # (GLOBAL_MAX_HOSTS,) int32 — max PID of orphaned decoy procs
...
def create_initial_state() -> CC4State:
    return CC4State(
        ...
        fsm_host_entered=jnp.zeros((NUM_RED_AGENTS, GLOBAL_MAX_HOSTS), dtype=jnp.bool_),
        ...
        host_orphaned_decoy_max_pid=jnp.zeros(GLOBAL_MAX_HOSTS, dtype=jnp.int32),
