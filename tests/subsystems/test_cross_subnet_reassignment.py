...
def test_cross_subnet_reassignment_does_not_overclear_existing_scan_memory_matches_cyborg():
    ...
    jax_state = jax_state.replace(
        ...
        red_scanned_source_hosts=jax_state.red_scanned_source_hosts.at[source_agent, keep_host_idx, keep_host_idx].set(True),
...
def test_cross_subnet_reassignment_keeps_remote_scan_memory_when_unrelated_session_moves_matches_cyborg():
    ...
    jax_state = jax_state.replace(
        ...
        red_scanned_source_hosts=jax_state.red_scanned_source_hosts.at[source_agent, remote_scan_host, keep_host_idx].set(
            True
        ),
