        ...
        (
            {
                ...
                "eval.checkpoint.cia.c.mean_plus_std": 0.5,
                "eval.checkpoint.cia.i.mean": -2.0,
                "eval.checkpoint.cia.i.std": 2.5,
                "eval.checkpoint.cia.i.mean_minus_std": -4.5,
                "eval.checkpoint.cia.i.mean_plus_std": 0.5,
                "eval.checkpoint.cia.a.mean": -3.0,
                "eval.checkpoint.cia.a.std": 3.5,
                "eval.checkpoint.cia.a.mean_minus_std": -6.5,
                "eval.checkpoint.cia.a.mean_plus_std": 0.5,
            },
            300,
        )
    ]
